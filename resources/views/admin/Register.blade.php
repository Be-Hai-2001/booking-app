...
<body class="">
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://vdbnhatranghotel.vn/bay-tu-tphcm-ra-da-nang-mat-bao-lau/imager_3314.jpg');">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Chào Mừng..!</h1>
              <p class="text-lead text-white">Sử dụng các biểu mẫu tuyệt vời này để đăng nhập hoặc tạo tài khoản mới trong dự án của bạn miễn phí</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('Register') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Tên chủ tài khoản" name="tenUser">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Căn cước công dân" name="cccd">
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Mật khẩu" name="password">
                    <input type="text" name="trangThai" value="1" hidden=true>
                    <input type="text" name="is_admin" value="0" hidden=true>
                  </div>
