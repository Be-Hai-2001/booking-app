...
<body>
   ...
   <div class="table service">
       <div class="create"><a href="{{ route('servicerooms.create') }}">Tiện ích Loại phòng</a></div>
       <div class="title">
   ...
   @foreach ($serviceRoom as $service)

       <div class="content" style="height: 5rem">
           <div class="id-service">{{ $service->id }}</div>
           <div class="tenKS-service">{{ $service->roomtype_id }}</div>
